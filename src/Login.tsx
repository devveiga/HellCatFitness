...
import { CadastroUsuarioForm } from './components/CadastroUsuarioForm'; // Importe o componente de cadastro
...
export default function Login() {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900">
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(verificaLogin)}>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                ...
                <button
                  type="button"
                  onClick={() => setMostrarCadastro(true)} // Exibe o formulário de cadastro
      ...
      {/* Exibe o formulário de cadastro apenas quando o estado 'mostrarCadastro' for verdadeiro */}
      {mostrarCadastro && (
